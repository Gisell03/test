...
<link rel="stylesheet" href="../css/personal_portada.css">
<style type="text/css">
	.login-form {
		width: 340px;
    	margin: 20px auto;
...
<?php include("vistaperso.php");?>
	...
	<td>
	<a class="btn btn-primary" href="editar.php?id=<?php echo $reg['id']; ?> "><i class="fa-solid fa-user-pen"></i>Editar</a>
    </td>
      <td>
