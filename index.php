...
<form method="post" class="login" class="form-horizontal">
	<fieldset>
	<legend class="legend">Iniciar sesion</legend>
  <div class="form-group">
  <div class="col-sm-12 input">
  <input type="text" name="txt_email" class="form-control" placeholder="Ingrese correo" />
  ...
  <div class="form-group">
      ...
      <div class="col-sm-12">
      <select class="form-control input" name="txt_role">
  ...
  <div class="form-group">
  <div class="col-sm-12">
  <input type="submit" name="btn_login" class="btn btn-success btn-block submit" value="Iniciar Sesion">
  </div>
  </div>
