...
<form method="post" class="form-horizontal" class="login">
<fieldset>
...
<div class="form-group">
<div class="col-sm-12">
<input type="submit" name="btn_register" class="btn btn-primary btn-block submit" value="Registro">
<button><a href="admin_portada.php" class="btn btn-danger">Cancelar</a></button>
</div>
</div>
</form>
